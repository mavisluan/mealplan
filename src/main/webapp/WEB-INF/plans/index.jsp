...
<div class="container mt-5 col-6">
    ...
    <a href="/plans/new" role="button" class="btn btn-primary float-right">Create A Plan</a>
    ...
    <table class="table mt-3">
        ...
        <tbody>
        <tr>
            <td><a href="/plans/4">Week 4</a></td>
            <td>
                <a href="#" role="button" class="h4 ml-3"><i class="fas fa-edit"></i></a>
                <a href="#" role="button" class="h4 ml-3"><i class="fas fa-trash-alt"></i></a>
                <a href="#" role="button" class="h4 ml-3"><i class="fas fa-share-square"></i></a>
            </td>
        </tr>
        <tr>
            <td><a href="/plans/3">Week 3</a></td>
            <td>
                <a href="#" role="button" class="h4 ml-3"><i class="fas fa-edit"></i></a>
                <a href="#" role="button" class="h4 ml-3"><i class="fas fa-trash-alt"></i></a>
                <a href="#" role="button" class="h4 ml-3"><i class="fas fa-share-square"></i></a>
