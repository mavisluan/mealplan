...
<div class="container mt-5">
    ...
    <form:form method="POST" action="/plans/new1" modelAttribute="plan" class="mt-5">
    <div class="form-group row">
        <form:label path="name" class="col-sm-3 col-form-label"><span class="h4">Create a plan:</span></form:label>
        <form:input path="name" class="form-control col-sm-5"/>
        <p><form:errors path="name" class="text-danger col-sm-10 offset-3"></form:errors></p>
    </div>
                    ...
                    <div class="container">
                        ...
                        <c:choose>
                            ...
                            <c:otherwise>
                                ...
                                <a href="/dishes/${day.dishes.get(0).id}/delete" class="ml-3"><i
                    ...
                    <div class="container">
                        ...
                        <c:choose>
                            ...
                            <c:otherwise>
                                ...
                                <a href="/dishes/${day.dishes.get(1).id}/delete" class="ml-3"><i
                                        class="fas fa-trash-alt"></i></a>
                            </c:otherwise>
                        </c:choose>
                    </div>
                    ...
                    <div class="container">
                        ...
                        <c:choose>
                            ...
                            <c:otherwise>
                                ...
                                <a href="/dishes/${day.dishes.get(2).id}/delete" class="ml-3"><i
                                        class="fas fa-trash-alt"></i></a>
                            </c:otherwise>
                        </c:choose>
                    </div>
...
<input type="submit" value="Create!" class="btn btn-dark offset-10"/>
</form:form>
</div>
</body>
</html>
